...
Identify customers at high risk of churn and identify the main indicators of churn for a leading telecom firm basis their custom-level data.

**Details of files in the folder:**

**Telecom_Churn_v3.ipynb:** Jupyter notebook file with complete source code.

**Telecom_Churn.pdf:** Presentation on the outcome of analysis.
